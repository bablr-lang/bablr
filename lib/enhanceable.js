...
export function streamParse(language, matcher, sourceText, props = o({}), options = {}) {
  ...
  return bablr_(context, source, language, createParseStrategy_(matcher, props), options);
}
      ...
      return (quasis, ...expressions) => {
        ...
        let matcher = buildPropertyMatcher(
          ...
          buildBoundNodeMatcher(
            ...
            buildTreeNodeMatcher(buildTreeNodeMatcherOpen(buildNodeFlags({ hasGap }), null, name)),
          ),
        );
